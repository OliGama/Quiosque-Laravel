    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <div class="col d-flex justify-content-end gap-2">
                ...
                <a href="{{ route('mesas.index') }}" class="btn btn-md btn-outline-primary shadow active" role="button">Concluir</a>
                ...
                <form method="POST" action="{{ route('pedidos.destroy', [$pedido, $mesa]) }}">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-md btn-secondary">Finalizar Mesa</button>
                </form>
            </div>
        </div>
    </div>
